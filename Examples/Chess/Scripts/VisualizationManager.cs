...
namespace SimpleAR.Examples.Chess.Scripts
{
    public class VisualizationManager: MonoBehaviour
    {
        ...
        {
            foreach (var move in gameObject.GetComponentsInChildren<HighlighMove>())
            {
        ...
        public IntCell PositionToCell(Vector3 pos)
        {
            ...
            int cellX = (int) ((boardPos.x + CellSizes.X / 2) / CellSizes.X);
            int cellY = (int) ((boardPos.z + CellSizes.Y / 2) / CellSizes.Y);
